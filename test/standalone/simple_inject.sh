...
TX=`../../pettycoin-tx from-gateway $GATEPRIVKEY P-$ADDR2 100`
../../pettycoin-query --pettycoin-dir=$DIR sendrawtransaction $TX

# ADDR2 pays half to ADDR3 (no fee)
TX2=`../../pettycoin-tx --no-fee tx $PRIVKEY2 P-$ADDR3 50 50 raw:$TX`
...
TX3=`../../pettycoin-tx to-gateway $PRIVKEY3 P-$GATEADDR 25 24 raw:$TX2`
